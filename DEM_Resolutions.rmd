---
title: "How does changing the resolution of environmental rasters affect modelling mean tempeature?"
...
```{r}
# Fix memory issue....(from stackoverflow)
tmpdir_name <- paste(c("D", ":/RASTER_TEMP/"), collapse='')
...
# Resolution (in metres) to 
 resolutions <- c(200, 400, 1000)
